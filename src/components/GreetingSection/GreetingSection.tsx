...
export const GreetingsSection = () => {
  ...
  return (
    <Container ref={ref} className={inView ? "is-visible" : ""}>
      <h4 className="hello-section">
        Olá, me chamo Ulisses <span className="waving-hand">&#128075;</span>
      </h4>
      <div className="summary-container">
        ...
        <div className="avatar-container">
          <img
            className="abstract-dash-border"
            src={AbstractDashBorder}
            alt=""
          />
      ...
      <div className="contact-screen">
        <p>
          Conheça um pouco do meu trabalho e fique à vontade para entrar em
          contato.
        </p>
